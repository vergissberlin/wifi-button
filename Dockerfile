...
ARG SECRET_WIFI_PASSWORD
ARG SECRET_MQTT_USER
ARG SECRET_MQTT_PASSWORD
ENV SECRET_WIFI_SSID="${SECRET_WIFI_SSID}"
ENV SECRET_WIFI_PASSWORD="${SECRET_WIFI_PASSWORD}"
ENV SECRET_MQTT_USER="${SECRET_MQTT_USER}"
ENV SECRET_MQTT_PASSWORD="${SECRET_MQTT_PASSWORD}"

RUN sed -i "s/YOUR-SSID/${SECRET_WIFI_SSID}/g" wifi-button/arduino_secrets.h
RUN sed -i "s/YOUR-PASSWORD/${SECRET_WIFI_PASSWORD}/g" wifi-button/arduino_secrets.h
RUN sed -i "s/YOUR-MQTT-USER/${SECRET_MQTT_USER}/g" wifi-button/arduino_secrets.h
RUN sed -i "s/YOUR-MQTT-PASSWORD/${SECRET_MQTT_PASSWORD}/g" wifi-button/arduino_secrets.h
